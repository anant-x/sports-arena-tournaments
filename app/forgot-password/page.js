  ...
  return (
    <main className="px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        />
        <div className="mt-8 rounded-lg border border-graphite/10 bg-white p-6 shadow-sm">
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            {whatsapp ? (
              <a href={whatsapp} target="_blank" rel="noreferrer" className="rounded-md bg-[#25D366] px-5 py-3 text-sm font-black text-pitch">
                WhatsApp Support
              </a>
            ) : null}
            <Link href="/login" className="rounded-md border border-graphite/15 px-5 py-3 text-sm font-black text-pitch">
              Back to Login
            </Link>
          </div>
        </div>
