        ...
        <table className="w-full min-w-[560px] text-left text-sm sm:min-w-[680px]">
          <thead className="bg-pitch text-white">
            <tr>
              ...
              <th className="px-3 py-3 text-center sm:px-4">Pts</th>
              <th className="px-3 py-3 text-center sm:px-4">NRR</th>
            </tr>
          </thead>
          <tbody>
            {rows.map((row, index) => {
              ...
              return (
                <tr key={row.team} className="border-t border-graphite/10 odd:bg-floodlight/55 transition hover:bg-crease/10">
                  ...
                  <td className="px-3 py-3 text-center font-semibold sm:px-4">{row.played}</td>
                  <td className="px-3 py-3 text-center font-semibold sm:px-4">{row.won}</td>
                  <td className="px-3 py-3 text-center font-semibold sm:px-4">{row.lost}</td>
                  <td className="px-3 py-3 text-center font-black text-turf sm:px-4">{row.points}</td>
                  <td className="px-3 py-3 text-center font-semibold sm:px-4">{row.nrr}</td>
                </tr>
              );
            })}
          </tbody>
